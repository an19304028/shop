	...
	<form action="editpass" method="POST">
		<table>
			...
			<tr>
				...
				<td>
					<input type="password" style="font-family:Verdana" id="password" pattern="^[0-9A-Za-z]+$" maxlength="10" name="password" required /><br>
			...
			<tr>
				...
				<td>
					<input type="password" style="font-family:Verdana; background-color:#f8f8f8;" id="confirm" pattern="^[0-9A-Za-z]+$" maxlength="10" name="confirm" oninput="CheckPassword(this)"  required /><br>
