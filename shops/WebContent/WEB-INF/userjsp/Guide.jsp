...
<%@ include file="Header.jsp" %>
	...
	<section>
		...
		<div id="guide-detail">
			<p>佐川急便(宅急便)でお届けします。<br>配送料金(一律690円)　11,000円(税込)以上ご購入で送料無料
			<br><br>
			【配達時間指定について】<br>
			佐川急便の規定により、配送先が時間帯指定不可能地域に該当しますと、ご注文時に配送時間帯のご指定を頂きましても、ご希望の時間にお届けできない場合がございます。<br>
			また、当店では指定日配達は行っておりません。<br>
			<br>
	...
	<section>
		...
		<div id="guide-detail">
			...
			　・商品到着より7日以内にメールにてご連絡下さい。弊社にてメール確認後、迅速に対応させていただきます。<br>
			<br>
			　--　不良による交換返品の流れ　--<br>
			　　①弊社のお問い合わせフォームまたは、info@chocomee.shopに商品到着より7日以内にメールにてご連絡下さい。<br>
